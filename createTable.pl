...
use DBI; 
 ...
 my $dbh=DBI->connect("DBI:Pg:dbname=juagarcia; host=dbserver", "juagarcia","Esinux14",{'RaiseError'=>1});
  ...
  $dbh->do("create table UniProt(Entry varchar(25) primary key, Status varchar(25), Organism varchar(100), Length varchar(25000), GO varchar(50000), Sequence varchar(20000))");
...
while(<$file>){
    ...
    $sth1->execute($line[0],$line[2],$line[5],$line[6],$line[8],$line[10]);
